...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (heroCanvas && typeof THREE !== 'undefined') {
    ...
    const colors = [
      { r: 0.388, g: 0.4, b: 0.945 },   // Primary - #6366f1
      { r: 0.545, g: 0.361, b: 0.965 }, // Secondary - #8b5cf6
      { r: 0.659, g: 0.333, b: 0.969 }, // Tertiary - #a855f7
    ];
  ...
  // ==========================================================
  console.log('%c Hello, curious developer! ', 'background: linear-gradient(135deg, #6366f1, #8b5cf6); color: white; font-size: 16px; padding: 10px; border-radius: 5px;');
  console.log('%c This portfolio was crafted with passion by Manas Reddy Arumalla ', 'color: #a1a1aa; font-size: 12px;');
  console.log('%c Interested in robotics? Let\'s connect! ', 'color: #6366f1; font-size: 12px;');
